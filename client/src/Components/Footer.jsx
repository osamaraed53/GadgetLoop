        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-indigo-900 transition hover:text-indigo-800"
                >
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-indigo-900">About Us</p>

              <ul class="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    class="text-gray-700 transition hover:text-indigo-900"
                    href="/"
                  >
                    Company History
                  </a>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-indigo-900">Our Services</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-indigo-900">Helpful Links</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-indigo-900">Contact Us</p>
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      class="h-5 w-5 shrink-0 text-indigo-900"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      stroke-width="2"
        ...
        <div class="mt-12 border-t border-gray-100 pt-6">
          <div class="text-center sm:flex sm:justify-between sm:text-left">
            <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
              All Right Reserved &copy; 2023 Gadget Loop
            </p>
          </div>
        </div>
      </div>
